...
class AlipayPay {
     ...
     */
    public $notify_url = "http://120.77.202.192/notify_url.php";

    /**
     * @var String 页面跳转同步通知页面路径
     * 需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/
     */
    public $return_url = 'http://www.sunsiqiang.com/bigone/cz/public/home/paySuccess';
     ...
     */
    public function requestPay($out_trade_no, $subject, $total_fee) {
        /*         * ************************请求参数************************* */
        //支付类型
        $payment_type = "1";
        //必填，不能修改
