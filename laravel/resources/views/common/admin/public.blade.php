...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a href="{{url('admin/capital/add')}}" title="批次申请">批次申请</a></li>
					<li><a href="{{url('admin/capital/showme')}}" title="我的申请">我的申请</a></li>
					<li><a href="{{url('admin/capital/showall')}}" title="全部申请">全部申请</a></li>
		</ul>
	</dd>
</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a href="{{url('admin/redpacket/showme')}}" title="我的红包">我的红包</a></li>
					<li><a href="{{url('admin/redpacket/showall')}}" title="全部红包">全部红包</a></li>
		</ul>
	</dd>
</dl>
		<dl id="menu-product">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a href="{{url('admin/user/add')}}" title="添加管理员">添加管理员</a></li>
					<li><a href="{{url('admin/auth/show')}}" title="权限管理">权限管理</a></li>
...
<script type="text/javascript" src="{{ URL::asset('static/h-ui/js/H-ui.js') }}"></script> 
<script type="text/javascript" src="{{ URL::asset('static/h-ui.admin/js/H-ui.admin.page.js') }}"></script> 
<!--/_footer /作为公共模版分离出去-->
<!--请在下方写此页面业务相关的脚本-->
@yield('js')
<!--/请在上方写此页面业务相关的脚本-->
