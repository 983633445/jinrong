            ...
            <div class="metadata">
                <div class="gallery ui-slider-disabled">
                    <div class="img-preview" style="background-image: none;">
                    	<img src="../home/images/405923.jpg" alt="#" style="height: 300px; width: 300px; margin: -150px 0px 0px -150px; display: inline;">
                    </div>
                </div>
            
                <div class="property">
                    <div class="country">
                        <img class="icon-flag" width="30" height="30" style="vertical-align: -5px;" src="images/1.png" alt="美国">美国直邮
                    </div>
                
                	<h1 class="title">健安喜GNC  男性持久力  提精补肾 提高性能力 60粒</h1>
                    ...
                    <div class="prop-item prop-sku sku-empty">
                        <dl class="prop-item prop-amount">
                            <dt class="prop-label">数　　量</dt>
                            <dd class="prop-content">
                            <a id="amount-decrease" class="amount-decrease" href="javascript:;">-</a>
                            <input type="text" id="amount-input" name="num" class="amount-input" value="1" maxlength="5">
                            <a id="amount-increase" class="amount-increase" href="javascript:;">+</a>
                            </dd>
                        </dl>
                    </div>
            ...
            <script>
                $(function(){
                    $(document).on('click','#btn-addtocart',function(){
                        var productId = 2;// 需要加入购物车的货品id
                        var goodsId = 2;// 需要加入购物车的商品id
