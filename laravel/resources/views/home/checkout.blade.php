        ...
        <div class="checkout-box-bd">
            ...
            <div class="box-bd">
                <dl class="checkout-goods-list">
                    ...
                    <dd>
                        <div class="item-row" goodsid="{{$v['goodsId']}}" productid="{{$v['productId']}}">
                            <div class="col-1">
                                <div class="g-pic"><img src="{{$v['goodsImg']}}" width="40" height="40" /></div>
                                <div class="g-info"><a href="#"  target="_blank">{{$v['goodsName']}}</a></div>
                            </div>
                            <div class="col-2">{{$v['goodsPrice']}}元</div>
                            <div class="col-3">{{$v['payNum']}}</div>
                            <div class="col-4"><font color="#FF0000">{{$v['goodsPrice']}}元</font></div>
                        </div>
                    </dd>
             @endforeach
...
$(function(){
    ...
    for(var i=1;i<$(".col-2").length;i++){
        ...
        sum += parseInt($(".col-2").get(i).innerHTML)*parseInt(perNum);
    }
